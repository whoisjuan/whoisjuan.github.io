...
}, Base.each(['locked', 'visible', 'blendMode', 'opacity', 'guide', 'strokeOpacity','fillOpacity'],
	function(name) {
		var part = Base.capitalize(name),
			name = '_' + name;
		this['get' + part] = function() {
	...
	},
{
	...
	equals: function(item) {
		return item === this || item && this._class === item._class
				...
				&& this._strokeOpacity === item._strokeOpacity
				&& this._fillOpacity === item._fillOpacity
	...
	_clone: function(copy, insert) {
		...
		var keys = ['_locked', '_visible', '_blendMode', '_opacity',
				'_clipMask', '_guide', '_applyMatrix','_strokeOpacity','fillOpacity'];
	...
	draw: function(ctx, param, parentStrokeMatrix) {
		...
		if (!this._visible || this._opacity === 0 || this._strokeOpacity === 0 || this._fillOpacity === 0)
			return;
		...
		if (direct) {
			ctx.globalAlpha = opacity || strokeOpacity || fillOpacity;
			if (nativeBlend)
...
var Style = Base.extend(new function() {
	...
	hasFill: function() {
		if(this.getFillColor() === "transparent") {
			return "white";
		}
...
var SVGStyles = Base.each({
	...
	strokeOpacity: ['stroke-opacity','number'],
...
new function() {
	...
	function exportRaster(item) {
		...
		attrs.x = item.node.getAttribute('x');
		attrs.y = item.node.getAttribute('y')
		attrs.width = item.node.getAttribute('width');
		attrs.height = item.node.getAttribute('height');
...
new function() {
	...
	function applyOpacity(item, value, name) {
		var color = item[name === ('opacity') ? 'getFillColor'
				: 'getStrokeColor']();
		if (color) {
	...
	function importSVG(source, options, isRoot) {
		...
		if(item && item._type === "circle" && item._name === "bubble0") {
			item._style._values.fillColor._components[0] = 1,
			item._style._values.fillColor._components[1] = 1,
			item._style._values.fillColor._components[2] = 1;
			}
